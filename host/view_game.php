                ...
                <div class="table-responsive">
                  <table class="table table-dark table-borderless mb-0">
                    ...
                    <?php
                        ...
                        $l=$_SESSION['login_id'];
                            $s="select * from game where login_id='$l'";
                      ...
                      <tr>
                        ...
                        <td>Maximum <?php echo $row['players'] ?>&nbsp;</td>
                        <td><a type="submit"  style="text-decoration:none;color:black; border-radius: 25px;background-color:#F3C313;padding: 5px 32px;margin: 5px 5px;text-decoration:no-decoration"  href="view_booking.php?id=<?php echo $row['game_id'];?>"><b>Players</b></a>
