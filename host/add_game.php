      ...
      <div class="col-lg-8 col-xl-6">
        <div class="card rounded-3"  style="background-color:#5D6D7E ;">
          ...
          <div class="card-body p-4 p-md-5">
            ...
            <form class="px-md-2" action="game_action.php" method="post">

              <div class="form-outline mb-4">
                <input type="text" id="" placeholder="Competition Name" class="form-control" name="name"/>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-outline datepicker">
                    <input type="text" class="form-control" placeholder="Game Type"  id="" name="type" />
                ...
                <input type="number" id="" placeholder="Number of Players"  class="form-control" name="player"/>
...
<BR>
              <div class="row mb-4 pb-2 pb-md-0 mb-md-5">
                ...
                <div class="form-outline">
                <input type="date" id="" placeholder="Game Date" class="form-control" name="date"/>
                <!-- <label class="form-label" for="form3Example1w">Registration code</label> -->
                </div>
...
<center>
              <button type="submit" class="btn btn-success btn-lg mb-1">Create Game</button>
</center>
