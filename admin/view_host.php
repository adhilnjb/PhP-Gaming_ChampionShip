		...
		<div class="container">
			...
			<nav class="main-menu">
				<ul>
					...
					<li><a href="view_host.php">Host</a></li>
					<li><a href="view_player.php">Player</a></li>
				</ul>
			</nav>
		</div>
	</header>
                    ...
                    <?php
                      ...
                      <tr>
                        ...
                        <td>
                            <?php
                                $l= $row['login_id'];
                                $sql="select * from login where login_id='$l'";
                                ...
                                else if($w['login_status']=='0')
                                {
                            ?>
                                <a type="submit"  style="background-color:#629B53;padding: 8px 32px;margin: 5px 75px;text-decoration:no-decoration"  href="approve.php?id=<?php echo $w['login_id'];?>">Approve</a>
                            <?php
                                }
                            ?>
                        </td>
